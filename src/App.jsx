...
export default function App() {
  ...
  const triggerAIResponse = (scenario) => {
    ...
    setTimeout(() => {
      ...
      if (scenario === 'conciliacao') {
        ...
        html = (
          <div className="mt-2 p-2 bg-[#0d1017] border border-[#222938] rounded-lg text-[10px] space-y-1 font-mono">
            ...
            <button 
              ...
              className="w-full mt-2 py-1 bg-blue-600 hover:bg-blue-500 text-white rounded text-[10px] font-bold"
            >
        ...
        html = (
          <div className="mt-2 p-2 bg-[#0d1017] border border-[#222938] rounded-lg text-[10px] space-y-1">
  ...
  return (
    <div className="flex-1 flex bg-[#0b0f17] text-slate-300 min-h-screen overflow-hidden">
      
      {/* SIDEBAR NAVIGATION */}
      <aside className="w-64 bg-[#111622] border-r border-[#1e2533] flex flex-col justify-between shrink-0 z-30">
        <div>
          {/* Logo Area */}
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-lg font-extrabold tracking-tight text-white flex items-center">
                  DISK<span className="text-orange-400 font-bold ml-0.5">HUB</span>
                </h1>
                <span className="text-[10px] text-slate-500 uppercase tracking-wider font-semibold">ERP & CRM Cloud</span>
              </div>
            </div>
          </div>

          {/* Nav Links - Soft Blue & Orange Accents */}
          <nav className="p-4 space-y-1.5">
            ...
            >
              <Sparkles className="w-5 h-5 shrink-0 text-orange-400 animate-pulse" />
            ...
            >
              <ShieldCheck className="w-5 h-5 shrink-0 text-orange-400" />
      ...
      <main className="flex-1 flex flex-col min-w-0 overflow-y-auto relative pb-20 z-10">
          ...
          <div className="flex items-center space-x-4">
            <div className="relative w-64">
              ...
              <input 
                ...
                className="w-full pl-9 pr-4 py-1.5 bg-[#090b11] border border-[#1e2533] rounded-lg text-xs text-slate-400 focus:outline-none focus:border-blue-500/50 focus:ring-1 focus:ring-blue-500/50 transition-all"
              />
            </div>
          ...
          {currentTab === 'dashboard' && (
            <div className="space-y-8 animate-fadeIn">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                ...
                <div className="flex items-center space-x-2 bg-[#111622] border border-[#1e2533] px-3 py-1.5 rounded-lg text-xs font-semibold text-slate-300">
                  <Calendar className="w-4 h-4 text-blue-400" />
                  <span>Julho, 2026</span>
                </div>
              </div>

              {/* KPI Cards in soft Orange/Blue branding */}
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="bg-[#111622] border border-[#1e2533] rounded-xl p-6 relative overflow-hidden shadow-md group hover:border-orange-500/25 transition-all duration-300">
                ...
                <div className="bg-[#111622] border border-[#1e2533] rounded-xl p-6 relative overflow-hidden shadow-md group hover:border-blue-500/25 transition-all duration-300">
                ...
                <div className="bg-[#111622] border border-[#1e2533] rounded-xl p-6 relative overflow-hidden shadow-md group hover:border-emerald-500/25 transition-all duration-300">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div className="bg-[#111622] border border-[#1e2533] rounded-xl p-6 lg:col-span-2 shadow-md">
                  ...
                  <div className="relative w-full h-48 mt-4">
                    <svg className="w-full h-full" viewBox="0 0 500 150" preserveAspectRatio="none">
                      ...
                      <line x1="0" y1="30" x2="500" y2="30" stroke="#1e2533" strokeDasharray="4,4" strokeWidth="1"/>
                      <line x1="0" y1="75" x2="500" y2="75" stroke="#1e2533" strokeDasharray="4,4" strokeWidth="1"/>
                      <line x1="0" y1="120" x2="500" y2="120" stroke="#1e2533" strokeDasharray="4,4" strokeWidth="1"/>
                      <path d="M 0 150 Q 100 80, 200 110 T 400 40 L 500 60 L 500 150 L 0 150 Z" fill="url(#indigo-grad)"/>
                      <path d="M 0 150 Q 100 80, 200 110 T 400 40 L 500 60" fill="none" stroke="#3b82f6" strokeWidth="2.5" strokeLinecap="round"/>
                    </svg>
                  </div>
                  <div className="flex justify-between text-[10px] text-slate-500 mt-2 font-semibold font-mono">
                    <span>JAN</span><span>FEV</span><span>MAR</span><span>ABR</span><span>MAI</span><span>JUN</span><span>JUL</span>
                  </div>
                </div>

                <div className="bg-[#111622] border border-[#1e2533] rounded-xl p-6 shadow-md flex flex-col justify-between">
                  <div>
                  ...
                  <div className="mt-6 pt-4 border-t border-[#1e2533] text-center">
                    <button onClick={() => setCurrentTab('contabilidade')} className="text-xs font-bold text-blue-400 hover:text-blue-300 inline-flex items-center hover:underline">
          ...
          {currentTab === 'financeiro' && (
            <div className="space-y-8 animate-fadeIn">
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                ...
                <div className="flex bg-[#111622] border border-[#1e2533] p-1 rounded-lg space-x-1 text-xs">
                  <button 
              ...
              {financeSubTab === 'contas' && (
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 animate-fadeIn">
                  <div className="lg:col-span-2 space-y-6">
                    <h3 className="text-sm font-bold text-slate-400 uppercase tracking-wider">Saldo das Contas do Sistema</h3>
                    ...
                    <div className="p-5 bg-[#111622] border border-[#1e2533] rounded-xl space-y-4">
                      <div className="flex items-center space-x-2">
                  ...
                  <div className="bg-[#111622] border border-[#1e2533] rounded-xl p-6 shadow-md h-fit space-y-4">
                    ...
                    <form onSubmit={handleAccountTransfer} className="space-y-4 text-xs">
                      ...
                      <button 
                        type="submit" 
                        className="w-full py-2 bg-blue-600 hover:bg-blue-500 active:scale-95 text-white font-bold rounded-lg transition-all"
                      >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 animate-fadeIn">
                  ...
                  <div className="bg-[#111622] border border-[#1e2533] rounded-xl p-6 shadow-md h-fit space-y-4">
                    ...
                    <form onSubmit={handleCreateLancamento} className="space-y-4 text-xs">
                      <div className="flex bg-[#090b11] p-1 border border-[#1e2533] rounded-lg space-x-1">
                        <button 
                          type="button"
              ...
              {financeSubTab === 'conciliacao' && (
                <div className="bg-[#111622] border border-[#1e2533] rounded-xl p-6 shadow-md space-y-4 animate-fadeIn">
                    ...
                    {conciliationItems.map((item) => (
                      <div 
                        ...
                        className={`flex items-center justify-between p-3 rounded-lg border transition-all ${
                          item.matched ? 'bg-[#090b11]/20 border-[#1e2533]/60 opacity-60' : 'bg-[#090b11]/50 border-[#1e2533]'
                        }`}
                      >
                        <div className="flex items-center space-x-3">
                        ...
                        <div className="flex items-center space-x-4">
                          <span className={`text-xs font-mono font-bold ${
                            item.type === 'in' ? 'text-emerald-400' : 'text-orange-400'
                          }`}>
              ...
              {financeSubTab === 'taxas' && (
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 animate-fadeIn">
                  ...
                  <div className="lg:col-span-2 bg-[#111622] border border-[#1e2533] rounded-xl p-6 shadow-md space-y-4">
                    <div className="flex justify-between items-center border-b border-[#1e2533] pb-3">
                      ...
                      {isPlanEligible('advanced') ? (
                        ...
                        <span className="text-[9px] text-slate-500 bg-[#090b11] px-2 py-1 rounded">Requer Plano Advanced</span>
                      )}
                    </div>

                    <div className="space-y-3">
                      {pdvs.map(pdv => (
                        <div key={pdv.id} className="p-3 bg-[#090b11]/65 border border-[#1e2533] rounded-lg flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
                          <div>
                            <div className="flex items-center space-x-2">
                          ...
                          <div className="flex items-center space-x-4 w-full sm:w-auto justify-between sm:justify-end">
                            ...
                            {pdv.balance > 0 && isPlanEligible('advanced') && (
                              <button 
                                ...
                                className="px-2.5 py-1 bg-blue-600 hover:bg-blue-500 active:scale-95 text-white text-[10px] font-bold rounded"
                  ...
                  <div className="bg-[#111622] border border-[#1e2533] rounded-xl p-6 shadow-md space-y-4">
                    <h3 className="text-sm font-bold text-white border-b border-[#1e2533] pb-3">Gateway & Custos Operacionais</h3>
                    <div className="space-y-3 text-xs">
                      {Object.entries(gatewayRates).map(([key, data]) => (
                        <div key={key} className="flex justify-between items-center p-2 bg-[#090b11]/40 border border-[#1e2533] rounded">
                          <span className="font-semibold">{data.name}</span>
                          <span className="font-mono text-blue-400 font-bold">{data.rate}% {data.fixed > 0 && `+ R$ ${data.fixed}`}</span>
                        </div>
                      ))}
                    </div>
                  </div>
            ...
            <div className="space-y-8 animate-fadeIn">
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                ...
                <div className="flex bg-[#111622] border border-[#1e2533] p-1 rounded-lg space-x-1 text-xs">
                  <button 
                    ...
                    className={`px-3 py-1.5 rounded-md font-bold transition-all ${
                      accountingSubTab === 'bordero' ? 'bg-blue-600 text-white' : 'text-slate-400 hover:text-slate-200'
                    }`}
                  >
                    Borderô Eventos
                  </button>
                  <button 
                    ...
                    className={`px-3 py-1.5 rounded-md font-bold transition-all ${
                      accountingSubTab === 'notas' ? 'bg-blue-600 text-white' : 'text-slate-400 hover:text-slate-200'
                    }`}
                  >
                    Notas Fiscais (SEFAZ)
                  </button>
              ...
              {accountingSubTab === 'bordero' && (
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 animate-fadeIn">
                  ...
                  {/* Event list selector */}
                  <div className="bg-[#111622] border border-[#1e2533] rounded-xl p-6 shadow-md space-y-4">
                    <h3 className="text-sm font-bold text-white border-b border-[#1e2533] pb-3">Selecione o Evento</h3>
                    <div className="space-y-3">
                      {borderos.map(b => (
                        <button 
                          key={b.id}
                  ...
                  {(() => {
                    ...
                    return (
                      <div className="lg:col-span-2 bg-[#111622] border border-[#1e2533] rounded-xl p-6 shadow-md space-y-6 animate-fadeIn">
                        <div className="border-b border-[#1e2533] pb-4 flex justify-between items-start">
                          <div>
              ...
              {accountingSubTab === 'notas' && (
                <div className="bg-[#111622] border border-[#1e2533] rounded-xl p-6 shadow-md space-y-6 animate-fadeIn">
                  <div className="border-b border-[#1e2533] pb-3 flex justify-between items-center">
                    <div className="flex items-center space-x-2">
                  ...
                  <div className="overflow-x-auto">
                    <table className="w-full text-xs text-slate-300 border-collapse">
                      ...
                      <tbody>
                        {invoices.map(inv => (
                          <tr key={inv.id} className="border-b border-[#1e2533]/40 hover:bg-[#090b11]/20">
                            ...
                            <td className="p-3 text-center">
                              ...
                              {inv.status === 'Pendente' && (
                                <button 
                                  ...
                                  className="px-2 py-1 bg-blue-600 hover:bg-blue-500 text-white text-[9px] font-bold rounded"
                                >
                                  Transmitir
                                </button>
                              )}
              ...
              {accountingSubTab === 'fechamento' && (
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 animate-fadeIn">
                  <div className="lg:col-span-2 bg-[#111622] border border-[#1e2533] rounded-xl p-6 shadow-md space-y-6">
                    <div className="flex justify-between items-center border-b border-[#1e2533] pb-3">
                      <div className="flex items-center space-x-2">
                    ...
                    <div className="space-y-3 font-mono text-xs">
                      <div className="flex justify-between p-2 hover:bg-[#090b11]/20">
                        ...
                        <span className="text-emerald-450 font-bold">R$ {invoiceMonth === 'Julho' ? '2.580.000' : invoiceMonth === 'Junho' ? '1.920.000' : '1.450.000'}</span>
                      </div>
                      <div className="flex justify-between p-2 hover:bg-[#090b11]/20">
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                ...
                <div className="flex space-x-2">
                  <button 
                    ...
                    className="flex items-center space-x-1.5 px-3 py-1.5 bg-blue-600 hover:bg-blue-500 active:scale-95 text-white rounded-lg text-xs font-bold transition-all"
                  >
                      ...
                      <div className="space-y-3 flex-1 overflow-y-auto">
                        {leads.filter(l => l.stage === stage).map(lead => (
                          <div key={lead.id} className="bg-[#111622] border border-[#1e2533] hover:border-blue-500/20 p-3 rounded-lg shadow space-y-2 group transition-all">
                            ...
                            <div className="flex justify-between items-center pt-2 border-t border-[#1e2533]/40">
            ...
            <div className="space-y-8 animate-fadeIn">
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                ...
                <div className="flex bg-[#111622] border border-[#1e2533] p-1 rounded-lg space-x-1 text-xs">
                  <button 
                    ...
                    className={`px-3 py-1.5 rounded-md font-bold transition-all ${
                      marketingSubTab === 'campanhas' ? 'bg-blue-600 text-white' : 'text-slate-400 hover:text-slate-200'
                    }`}
                  >
                    Disparos & Campanhas
                  </button>
                  <button 
                    ...
                    className={`px-3 py-1.5 rounded-md font-bold transition-all ${
                      marketingSubTab === 'cupons' ? 'bg-blue-600 text-white' : 'text-slate-400 hover:text-slate-200'
                    }`}
                  >
                    Cupons
                  </button>
                  <button 
                    ...
                    className={`px-3 py-1.5 rounded-md font-bold transition-all ${
                      marketingSubTab === 'performance' ? 'bg-blue-600 text-white' : 'text-slate-400 hover:text-slate-200'
                    }`}
                  >
                    Métricas & ROI
                  </button>
              ...
              {marketingSubTab === 'campanhas' && (
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 animate-fadeIn">
                  ...
                  <div className="lg:col-span-2 bg-[#111622] border border-[#1e2533] rounded-xl p-6 shadow-md space-y-4">
                    <div className="flex justify-between items-center border-b border-[#1e2533] pb-3">
                      ...
                      <button 
                        ...
                        className="px-2 py-1 bg-[#1e2533]/85 hover:bg-blue-600 text-white text-[10px] font-bold rounded"
                      >
                        Nova Campanha
                      </button>
                    </div>
                    ...
                    <div className="overflow-x-auto">
                      <table className="w-full text-xs text-slate-300 border-collapse">
                        ...
                        <tbody>
                          {campaigns.map(camp => (
                            <tr key={camp.id} className="border-b border-[#1e2533]/40 hover:bg-[#090b11]/20">
                              <td className="p-3">
                                <div>
                  ...
                  <div className="bg-[#111622] border border-[#1e2533] rounded-xl p-6 shadow-md space-y-4 h-fit">
                    <h3 className="text-sm font-bold text-white border-b border-[#1e2533] pb-3">Dicas de Conversão</h3>
                    <p className="text-xs text-slate-400">
                      Disparos via WhatsApp possuem uma taxa de clique média de 18.5%, contra 6.4% em campanhas de E-mail de reengajamento.
                    </p>
                    
                    <div className="p-3 bg-[#090b11] rounded-lg border border-[#1e2533] space-y-2">
              ...
              {marketingSubTab === 'cupons' && (
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 animate-fadeIn">
                  <div className="lg:col-span-2 bg-[#111622] border border-[#1e2533] rounded-xl p-6 shadow-md space-y-4">
                    ...
                    <div className="space-y-3">
                      {coupons.map(coupon => (
                        <div key={coupon.id} className="flex items-center justify-between p-3 rounded-lg bg-[#090b11]/40 border border-[#1e2533]">
                          <div className="flex items-center space-x-3">
                            <div className="w-10 h-10 rounded bg-[#1e2533] text-orange-400 font-bold flex items-center justify-center text-xs">
                              {coupon.discount}%
                            </div>
                            <div>
              ...
              {marketingSubTab === 'performance' && (
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 animate-fadeIn">
                  <div className="bg-[#111622] border border-[#1e2533] rounded-xl p-5 shadow-sm">
                  ...
                  <div className="bg-[#111622] border border-[#1e2533] rounded-xl p-5 shadow-sm">
                    ...
                    <span className="text-xl font-mono font-extrabold text-blue-400 mt-1 block">47.6%</span>
                  </div>
                  <div className="bg-[#111622] border border-[#1e2533] rounded-xl p-5 shadow-sm">
                    <span className="text-[9px] text-slate-500 uppercase tracking-widest font-bold block">Total Ingressos Vendidos</span>
                    <span className="text-xl font-mono font-extrabold text-orange-400 mt-1 block">{campaigns.reduce((acc, c) => acc + c.conversions, 0)}</span>
                  </div>
                </div>
              )}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {appsCatalog.map(app => {
                  ...
                  return (
                    <div 
                      key={app.id} 
                      className={`bg-[#111622] border rounded-xl p-6 flex flex-col justify-between transition-all duration-300 ${
                        eligible 
                          ? 'border-[#1e2533] hover:border-slate-700 hover:shadow-lg' 
                          : 'border-[#1e2533]/80 opacity-80'
                      }`}
                    >
                      <div>
                        <div className="flex items-start justify-between mb-4">
                          <div className={`w-12 h-12 rounded-lg flex items-center justify-center ${
                            eligible ? 'bg-blue-500/10 text-blue-400' : 'bg-slate-800 text-slate-600'
                          }`}>
                          ...
                          <div className="flex flex-col items-end space-y-1">
                            {installed ? (
                              ...
                              <span className="bg-orange-500/10 text-orange-400 text-[9px] px-2 py-0.5 rounded-full font-bold uppercase tracking-wider flex items-center space-x-1">
                      ...
                      <div className="mt-6 pt-4 border-t border-[#1e2533]">
                        {installed ? (
                          <button 
                            disabled 
                            className="w-full py-2 bg-[#090b11] text-slate-500 text-xs font-bold rounded-lg cursor-not-allowed flex items-center justify-center space-x-1"
                          >
                            <CheckCircle className="w-3.5 h-3.5" />
                          ...
                          <button 
                            disabled 
                            className="w-full py-2 bg-[#090b11] text-slate-400 text-xs font-bold rounded-lg flex items-center justify-center space-x-2"
                          >
                          ...
                          <button 
                            ...
                            className="w-full py-2 bg-blue-600 hover:bg-blue-500 active:scale-[0.98] text-white text-xs font-bold rounded-lg transition-all"
                          >
                            Instalar Módulo
                          </button>
                        ) : (
            ...
            <div className="space-y-8 animate-fadeIn text-center">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 pt-6 max-w-5xl mx-auto text-left">
                ...
                <div className={`bg-[#111622] border rounded-2xl p-8 flex flex-col justify-between relative hover:border-slate-700 transition-all ${
                  plan === 'standard' ? 'border-blue-500' : 'border-[#1e2533]'
                }`}>
                  {plan === 'standard' && <div className="absolute top-4 right-4 bg-emerald-500/10 text-emerald-450 text-[10px] px-3 py-1 rounded-full font-bold">ATIVO</div>}
                  <div>
                    <span className="text-xs font-bold text-blue-400 uppercase tracking-widest block">Iniciante</span>
                ...
                {/* Advanced */}
                <div className={`bg-[#111622] border rounded-2xl p-8 flex flex-col justify-between relative hover:border-blue-500 transition-all ${
                  plan === 'advanced' ? 'border-blue-500' : 'border-blue-500/10'
                }`}>
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-gradient-to-r from-blue-500 to-orange-500 text-white text-[10px] px-4 py-1 rounded-full font-bold tracking-widest shadow-md">RECOMENDADO</div>
                  {plan === 'advanced' && <div className="absolute top-4 right-4 bg-emerald-500/10 text-emerald-450 text-[10px] px-3 py-1 rounded-full font-bold">ATIVO</div>}
                  <div>
                    <span className="text-xs font-bold text-blue-400 uppercase tracking-widest block">Profissional</span>
                ...
                <div className={`bg-[#111622] border rounded-2xl p-8 flex flex-col justify-between relative hover:border-slate-700 transition-all ${
                  ...
                  <div>
                    <span className="text-xs font-bold text-orange-400 uppercase tracking-widest block">Alta Escala</span>
          ...
          {currentTab === 'roadmap' && (
            <div className="space-y-8 animate-fadeIn">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                {/* Phase 1 */}
                <div className="bg-[#111622] border border-emerald-500/20 rounded-xl p-6 shadow-sm flex flex-col justify-between">
                  <div>
                ...
                {/* Phase 3 */}
                <div className="bg-[#111622] border border-blue-500/20 rounded-xl p-6 shadow-sm flex flex-col justify-between">
                  <div>
                    <div className="flex items-center justify-between mb-4 border-b border-[#1e2533] pb-3">
        ...
        {/* NOTIFICATION TOAST */}
        {toast.show && (
          <div className="fixed bottom-6 left-6 z-50 bg-[#111622] border border-blue-500/35 text-slate-100 px-5 py-4 rounded-xl shadow-2xl flex items-center space-x-3 transition-all duration-300 animate-slideUp">
        ...
        <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end">
          ...
          {chatOpen && (
            <div className="w-96 max-h-[500px] bg-[#111622] border border-[#1e2533] rounded-2xl shadow-2xl flex flex-col overflow-hidden mb-4 transition-all duration-300 origin-bottom-right">
              {/* Chat Header */}
              <div className="p-4 bg-[#0b0f17] border-b border-[#1e2533] flex items-center justify-between">
              ...
              <div className="p-3 bg-[#090b11] border-t border-[#1e2533]">
                <p className="text-[9px] text-slate-500 uppercase tracking-wider font-bold mb-2">Comandos Rápidos</p>
                <div className="grid grid-cols-2 gap-2">
                  <button onClick={() => triggerAIResponse('conciliacao')} className="px-2 py-1.5 text-[10px] font-medium bg-[#111622] border border-[#1e2533] hover:border-blue-500 hover:bg-blue-600/5 text-slate-300 rounded text-left truncate transition-all">
                    🔍 Fazer Conciliação
                  </button>
                  <button onClick={() => triggerAIResponse('dre')} className="px-2 py-1.5 text-[10px] font-medium bg-[#111622] border border-[#1e2533] hover:border-blue-500 hover:bg-blue-600/5 text-slate-300 rounded text-left truncate transition-all">
                    📊 Gerar DRE
                  </button>
                  <button onClick={() => triggerAIResponse('nfe')} className="px-2 py-1.5 text-[10px] font-medium bg-[#111622] border border-[#1e2533] hover:border-blue-500 hover:bg-blue-600/5 text-slate-300 rounded text-left truncate transition-all">
                    🧾 Notas Pendentes
                  </button>
                  <button onClick={() => triggerAIResponse('borderos')} className="px-2 py-1.5 text-[10px] font-medium bg-[#111622] border border-[#1e2533] hover:border-blue-500 hover:bg-blue-600/5 text-slate-300 rounded text-left truncate transition-all">
                    📋 Status Borderôs
                  </button>
                </div>
              </div>
              ...
              {/* Chat Input */}
              <form onSubmit={handleSendCustomText} className="p-2.5 bg-[#111622] border-t border-[#1e2533] flex space-x-2">
                <input 
                  type="text" 
                  value={userInput}
          ...
          <button 
            ...
            className="w-14 h-14 bg-blue-600 hover:bg-blue-500 text-white rounded-full flex items-center justify-center shadow-2xl shadow-blue-500/30 hover:scale-105 active:scale-95 transition-all duration-200 focus:outline-none"
          >
      ...
      {/* 1. ADD LEAD MODAL */}
      {showAddLeadModal && (
        <div className="fixed inset-0 bg-[#090b11]/70 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-[#111622] border border-[#1e2533] rounded-2xl w-full max-w-md overflow-hidden shadow-2xl animate-scaleUp">
            <div className="p-6 border-b border-[#1e2533] flex justify-between items-center bg-[#111622]">
            ...
            <form onSubmit={handleCreateCoupon} className="p-6 space-y-4">
              <div className="space-y-1">
                ...
                <input 
                  ...
                  className="w-full bg-[#090b11] border border-[#1e2533] rounded-lg p-2 text-xs focus:outline-none focus:border-blue-500 text-slate-300 uppercase tracking-wider font-mono"
                  required
                />
              </div>
